...
// Add adds a rating for a given record.
func (r *Repository) Add(ctx context.Context, recordId model.RecordID, recordType model.RecordType, rating *model.Rating) error {
	if _, ok := r.data[recordType]; !ok {
